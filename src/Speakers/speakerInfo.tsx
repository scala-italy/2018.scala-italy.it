...
export const keynotes: Speakers = {
  klang: {
    ...
    abstract: (
      <div>
        <p>
          Is there a possible unification of stream processing a.k.a. Fast Data, and Microservices?
        </p>
  ...
  miller: {
    ...
    bio: (
      <div>
        <p>
          Heather Miller is the executive director of the Scala Center at EPFL, where she is a
          research scientist, and an Assistant Clinical Professor at Northeastern University in
          Boston.
        </p>
        <p>
          She recently completed her PhD in EPFL's Faculty of Computer and Communication Science
          where she contributed to the now-widespread programming language, Scala. Heather's
          research interests are at the intersection of data-centric distributed systems and
          programming languages, with a focus on transferring her research results into industrial
          use.
        </p>
        <p>
          She has also led development of popular MOOCs some 800,000 students strong, such as
